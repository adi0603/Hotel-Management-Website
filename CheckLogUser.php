...
<nav class="navbar is-black">
    ...
    <button class="button is-black">End User / Guest Logs</button>
    </div>
...
<center>
          <table class="rwd-table">
            ...
            <tbody>
              <tr>
                <th colspan="3">Guest Logs</th>
              </tr>
              <th>Name</th>
              <th>Email</th>
              <th>Login Time</th>
              <?php
                $result1 = mysqli_query($con,"select * from user join logfile where user.email=logfile.email and category='Customer'");
